# <span style="color:#7492f7;">Rutas comunes.</span>
...
Desplazarse por los directorios (tab repetido = cambiar sugerencia; escribir + tab = autocompletar)
...
<!--Se creará un archivo .gitconfig en C:\Users\Diego-->
...
<!--Crear un repositorio es igual a hacer que Git comience a funcionar en un directorio, es decir, que el directorio tenga un control de versiones.-->
...
<!--Se creará un archivo .git en el directorio.-->
...
<!--Nota-->
<!--git add . -->
<!-- (con punto) agrega todos los archivos del directorio pendientes (local area) al área de preparación (staging area)-->
...
1. En github, en el repositorio de mouredev, se hace click en 'fork', y se selecciona la cuenta de github del usuario. Se creará una copia en la cuenta del usuario, llamada 'mouredev-fork'.
